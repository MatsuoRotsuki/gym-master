    ...
    >
      <div className="flex items-start justify-start gap-4">
        ...
        <div className="flex flex-col items-start justify-start gap-2">
          <DetailWrapper className="text-xl" label="Tên sản phẩm: " title={equipment.name} />
          ...
          <DetailWrapper className="text-xl" label="Mô tả: " title={equipment.description} />

          <div>
            <p className="col-span-2 text-base font-medium text-noneSelected">Nằm ở phòng gym: </p>
